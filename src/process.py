...
def main():
  with open('H:\\ubuntu_fiels\enas-rnn-search\src\ptb.train.txt') as finp:
  ...
  with open('H:\\ubuntu_fiels\enas-rnn-search\src\ptb.valid.txt') as finp:
    lines = finp.read().strip().replace('\n', '<eos>')
    words = lines.split(' ')
  ...
  with open('H:\\ubuntu_fiels\enas-rnn-search\src\ptb.test.txt') as finp:
    lines = finp.read().strip().replace('\n', '<eos>')
    words = lines.split(' ')
