...
#os.environ["PATH"] += os.pathsep + '/home/CW01/uic15256/anaconda3/envs/tfenv/bin'

def construct_block(graph, num_block, ops):

    ops_name = ["conv 3x3", "SepConv 3x3", "Conv 5x5", "SepConv5x5", "avg pool", "max pool", "identity", "add", "concat"]
...
def main():
    ...
    if(len(sys.argv) <= 1):
        norm_cell = "0 3 1 0 2 4 1 0 2 0 1 1"
        redu_cell = "1 0 1 1 0 1 2 0 1 1 2 1"
    else:
        norm_cell, redu_cell = "", ""
